...
// Uses gemini-pro — works on ALL versions of @google/generative-ai SDK
// No package update needed
...
async function getAIReading(chart, question, userName) {
  ...
  // gemini-pro works on ALL SDK versions — most compatible choice
  ...
  try {
    ...
    if (msg.includes('429') || msg.includes('quota')) {
      throw new Error('Gemini quota exceeded. Please wait a minute and try again.');
    }
